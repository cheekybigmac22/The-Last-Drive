...
Persistent, irregular regions extend in every direction: desert dunes and pyramids; jungle temples and pools; houses and fountains in towns; meadow barns and hay bales; snowy cabins and ice; coastal boats and lighthouses. Farther regions become corrupted forest, hollow ruins and monster-world terrain. Regions have varied sizes, not fixed distance stages. Roads and stable numbered landmarks make a time-loop rewind recognizable. A loop restores a previous position, not a newly randomized view.
